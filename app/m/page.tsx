...
export default function MobileHomePage() {
  ...
  async function triggerInstall() {
    if (!installPrompt) {
      alert("To install: tap your browser's Share/Menu button, then choose 'Add to Home Screen' or 'Install app'.")
      return
    }
            ...
            <button onClick={triggerInstall}
              ...
              <div className="text-left flex-1 min-w-0">
                ...
                <p className="text-[10px] text-muted-foreground">
                  {installPrompt ? "Tap to install on your device" : "Use Share menu → Add to Home Screen"}
                </p>
              </div>
            </button>
          )}
